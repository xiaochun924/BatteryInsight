...
final class BatteryViewModel: ObservableObject {
    ...
    private static func merged(_ old: AnalyticsRecord, _ fresh: AnalyticsRecord) -> AnalyticsRecord {
        AnalyticsRecord(
            ...
            unpluggedDurationSeconds: old.unpluggedDurationSeconds ?? fresh.unpluggedDurationSeconds,
            screenOnSeconds: old.screenOnSeconds ?? fresh.screenOnSeconds,
            awakeSeconds: old.awakeSeconds ?? fresh.awakeSeconds,
            chargingMinutes: old.chargingMinutes ?? fresh.chargingMinutes,
            chargingCount: old.chargingCount ?? fresh.chargingCount,
